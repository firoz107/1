  ...
  try {
    ...
    if ($result[0]["count"] > 0) {
      ...
      if ($result > 0) {
        ...
        $mail->Username = 'vectorx107@gmail.com';
        $mail->Password = 'qwerty#@!';

        $mail->SetFrom('vectorx107@gmail.com', 'Vector X');
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="well contact-form-container">
        <form class="form-horizontal contactform" action="signup.php" name="f" method="post" onsubmit="return validateForm();">
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-lg-10">
                <button class="btn btn-primary" type="submit" name="sub">Sign Up</button> 
              </div>
            </div>
          </fieldset>
        </form>
